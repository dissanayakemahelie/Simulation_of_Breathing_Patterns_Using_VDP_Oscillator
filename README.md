This project focuses on the simulation of both typical Normal and Periodic breathing signals, e.g. Cheyne-Stokes respiration, using a Van der Pol (VDP) oscillator for a span of approximately 1300 seconds. 
The VDP equation is modified according to a set of criteria needed to describe real-world signal dynamics: Time-varying frequency, asymmetry of inhalation and exhalation, amplitude envelope and Gaussian noise.
